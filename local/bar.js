var BackString = "<canvas style='z-index: -1;float:left;background-attachment:fixed; position:fixed;' id='canvas'></canvas><link rel='stylesheet' type='text/css'href='../local/OSXcss.css'><script src = '../local/back.js'></script> " // 背景
